...
function start() {
	...
	l1.innerHTML = "Following bugs have been fixed:";
	const l2 = document.createElement("SPAN");
	l2.setAttribute("class", "line");
	l2.innerHTML = "⚪ \"Number of followers is not found\" issue";
	const l3 = document.createElement("SPAN");
	l3.setAttribute("class", "line");
	l3.innerHTML = "⚫ Interface display issue";
	const l4 = document.createElement("SPAN");
	l4.setAttribute("class", "line");
	l4.innerHTML = "⚪ Minor issues since Instagram API has been changed";
